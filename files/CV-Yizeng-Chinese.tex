...
\documentclass[10.5pt, UTF8]{ctexart}
...
\begin{bibsection}
        ...
        \item Wangbo Zhao*, \textbf{Yizeng Han}*, Jiasheng Tang, Kai Wang, Hao Luo, Yibing Song, Gao Huang, Fan Wang, Yang You. DyDiT++: Diffusion Transformers with Timestep and Spatial Dynamics for Efficient Visual Generation. \emph{IEEE Transactions on Pattern Analysis and Machine Intelligence} (\textbf{TPAMI}), 2026.
        ...
        \item Wangbo Zhao, \textbf{Yizeng Han}, Zhiwei Tang, Jiasheng Tang, Pengfei Zhou, Kai Wang, Bohan Zhuang, Zhangyang Wang, Fan Wang, Yang You. RAPID$^3$: Tri-Level Reinforced Acceleration Policies for Diffusion Transformer. {International Conference on Learning Representations} (\textbf{ICLR}), 2026.
